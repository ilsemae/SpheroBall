...
class SocialForceServer:
  ...
  def handle(self, req):
    force = self.get_net_force(req.name, req.goal_name, req.goal_x, req.goal_y)
  ...
  def get_net_force(self, robot_name, goal_name, goal_x, goal_y):
    ...
    for i in range(self.n):
      ...
      if stranger != robot_name and stranger != goal_name:
