...
class SocialForceServer:
  ...
  def get_net_force(self, robot_name, partner_name, goal_x, goal_y):
    ...
    goal_coefficient = (self.n-1)*25 # Weight of the goal be proportional to total # of robots.
    ...
    for i in range(self.n):
      ...
      if stranger != robot_name and stranger != partner_name:
        ...
        stranger_force = 3*self.n/stranger_dist*stranger_pointer/stranger_dist
